    ...
    >
      ...
      <div className="container mx-auto p-4 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          {/* Main dashboard */}
<div className="col-span-12 md:col-span-9 lg:col-span-7 overflow-y-auto max-h-[calc(100vh-4rem)]">
          ...
          {/* Right sidebar */}
<div className="col-span-12 lg:col-span-3 overflow-y-auto max-h-[calc(100vh-4rem)]">
            <div className="grid gap-6">
              {/* System time */}
              <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm overflow-hidden">
